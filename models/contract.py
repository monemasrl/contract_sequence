...
class ContractContract(models.Model):
    ...
    _sql_constraints = [
        ("contract_contract_unique_number", "UNIQUE (number)", _("The number must be unique!")),
    ]
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get("number", "/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("contract.contract")
    ...
    def name_get(self):
        ...
        for contract in result:
            ...
            name = "[{}] {}".format(rec.number, contract[1])
